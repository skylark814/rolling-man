var NormalLayer = cc.Layer.extend({
    sprite: null,
    bg: null,
    mn1: null,
    mn2: null,
    ...
    ctor: function () {
        ...
        this.imgArr = [res.man_png, res.man_png, res.man_png, res.man_png, res.cat_png, res.cat2_png,
            res.cat3_png, res.cat_png, res.cat2_png, res.cat3_png];
        ...
        if ('mouse' in cc.sys.capabilities) {
            var mouseListener = {
                ...
                onMouseDown: function (event) {
                    ...
                    let dropDown = cc.moveTo(0.3, cc.p(x + 100, cc.winSize.height / 4-30));
                    let rote = cc.rotateBy(0.3, 360);
    ...
    onMenuCallback() {
        this.sprite.schedule(this.actionUpdate, 2, 10,0.1);
        this.removeChild(this.mn1);
        this.sprite.schedule(this.winOrLose, 0.1, 0, 20.1);
    },
    actionUpdate() {
        ...
        let bz = cc.bezierTo(1.5, bezier);
        let roll = cc.rotateBy(1.5, 360*10);
...
var NormalScene = cc.Scene.extend({
    onEnter: function () {
        this._super();
        var layer = new NormalLayer();
        this.addChild(layer);
    }
});
